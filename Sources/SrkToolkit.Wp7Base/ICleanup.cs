...
namespace SrkToolkit.Base {
    ...
    /// but without the implications that IDisposable presupposes. An 
    /// instance implementing ICleanup can be cleaned up without being 
    /// disposed and garbage collected. 
    /// </summary>
    /// <remarks>
    /// Inspired from Galasoft MVVM Light.
    /// </remarks>
